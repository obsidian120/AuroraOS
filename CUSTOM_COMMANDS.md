# Cyralith Custom Commands

Cyralith v17 adds a simple user-space command system.

## Idea
You do **not** need to change the kernel to add a new command.

A custom command consists of:
1. a **script file** somewhere in CyralithFS
...
Each line is just a normal Cyralith shell command.
...
## Current limitation
Cyralith does **not** run Python directly yet.
So the wrapper idea is similar to Linux, but the executable script content is currently **Cyralith shell script**, not real Python.
