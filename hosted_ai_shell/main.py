...
class AuroraShell:
    ...
    def print_banner(self) -> None:
        print("============================================================")
        print(VERSION)
        print("Thank you for using Cyralith!")
    ...
    def run(self) -> None:
        self.print_banner()
        print(self.t("Shell bereit. Apps, Nutzer, CyralithFS, Netzwerk, e1000-Grundlage und die neue Settings-App sind aktiv.", "Shell ready. Apps, users, CyralithFS, network, e1000 groundwork and the new settings app are active."))
        self.cmd_quickstart([])
        while self.running:
            try:
    ...
    def cmd_help(self, _: List[str]) -> None:
        rows = [
            ...
            ("fs", "Erklaert CyralithFS kurz.", "Explains CyralithFS briefly."),
            ...
            ("about", "Erklaert kurz die Idee hinter Cyralith.", "Explains the idea behind Cyralith."),
            ("ai <text>", "Nimmt normale Sprache entgegen.", "Accepts natural language."),
            ("exit", "Beendet die Demo.", "Exits the demo."),
        ]
        print(self.t("Cyralith Hilfe", "Cyralith help"))
